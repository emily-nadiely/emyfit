const CACHE='progressa-v6-4-7-smart-scale-import';
const CORE=['./','./index.html','./styles.css','./app.js','./plan-personalization.js','./cardio-mode.js','./cardio-recovery.js','./cycle-exercise-preferences.js','./measurement-import.js','./smart-scale-import.js','./share-target-import.js','./exercise-images.js','./manifest.json','./manifest.webmanifest','./progressa-icon-v640-192.png','./progressa-icon-v640-512.png','./progressa-icon-v640-maskable-512.png','./progressa-icon-v640-180.png','./favicon.ico'];
